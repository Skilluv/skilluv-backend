...
async fn setup_scim(app: &crate::common::TestApp, slug_input: &str) -> String {
...
async fn scim_get(app: &crate::common::TestApp, token: &str, path: &str) -> reqwest::Response {
    scim_client()
...
async fn scim_delete(app: &crate::common::TestApp, token: &str, path: &str) -> reqwest::Response {
    scim_client()
