...
async fn a_delivered_review_divides_the_fee_between_the_people_who_wrote() {
    ...
    crate::common::assert_amount(&body["data"]["commission"], "3600.00");
    ...
    crate::common::assert_decimal(&total, "5400.00");
}
...
async fn an_audit_is_not_delivered_until_everybody_has_seen_their_own() {
    ...
    .await
    .unwrap();
    crate::common::assert_decimal(&booked, "12000.00");
}
