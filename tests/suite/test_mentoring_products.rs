...
async fn subscribing_pays_the_mentor_and_books_the_platform_share() {
    ...
    .await
    .unwrap();
    crate::common::assert_decimal(&booked, "20.00");
}
...
async fn volunteer_hours_accumulate_and_report_the_threshold() {
    ...
    let resp = app
        ...
        .await;
    let body: Value = resp.json().await.unwrap();
    crate::common::assert_amount(&body["data"]["hours_with_this_mentee"], "4.00");
...
async fn a_cohort_is_priced_per_head_and_a_corporate_run_by_the_month() {
    ...
    crate::common::assert_amount(&body["data"]["program"]["commission_percent"], "20.00");
}
...
async fn a_company_client_carries_the_higher_commission() {
    ...
    crate::common::assert_amount(&body["data"]["program"]["commission_percent"], "25.00");
...
async fn enrolling_pays_the_mentor_their_share() {
    ...
    .await
    .unwrap();
    crate::common::assert_decimal(&booked, "120.00");
}
