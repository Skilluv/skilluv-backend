...
#[openapi(
    ...
    paths(
        ...
        crate::routes::quality::reference,
        crate::routes::quality::profile,
        crate::routes::quality::reports,
        crate::routes::quality::file_bug,
        crate::routes::quality::my_bugs,
        crate::routes::quality::link_fix,
        crate::routes::quality::confirm_fix,
        crate::routes::quality::review_bug,
        crate::routes::quality::review_queue,
        crate::routes::quality::import_run,
        crate::routes::quality::slice_runs,
        crate::routes::quality::verify_run,
        crate::routes::missions::read_nda,
        crate::routes::missions::sign_nda,
        crate::routes::missions::my_nda_signature,
        crate::routes::security::reference,
        crate::routes::security::scope,
        crate::routes::security::submit_report,
        crate::routes::security::my_reports,
        crate::routes::security::withdraw,
        crate::routes::security::answer_round,
        crate::routes::security::upload_proof,
        ...
        crate::routes::security::trust_summary,
        crate::routes::security::profile,
        crate::routes::security::external_bounties,
        crate::routes::security::issue_token,
        crate::routes::security::current_token,
        crate::routes::security::revoke_token,
        crate::routes::admin_security::overview,
        crate::routes::admin_security::queue,
        crate::routes::admin_security::add_comment,
        crate::routes::admin_security::list_tokens,
        crate::routes::admin_security::detail,
        crate::routes::admin_security::transition,
        crate::routes::admin_security::severity,
        crate::routes::admin_security::open_round,
        crate::routes::admin_security::resolve_round,
        crate::routes::admin_security::vendor_notified,
        crate::routes::admin_security::request_extension,
        crate::routes::admin_security::grant_extension,
        crate::routes::admin_security::withhold,
        crate::routes::admin_security::rescan,
        crate::routes::admin_security::dedup_queue,
        crate::routes::admin_security::embargo_sweep,
        crate::routes::admin_security::create_challenge,
        crate::routes::admin_security::list_bounties,
        crate::routes::admin_security::curate_bounty,
        crate::routes::admin_security::revoke_token,
        crate::routes::admin_security::lab_from_finding,
        crate::routes::admin_security::bounty_claims,
        crate::routes::admin_security::verify_bounty_claim,
        crate::routes::admin_security::refuse_bounty_claim,
        crate::routes::security::claim_bounty,
        crate::routes::security::my_bounty_claims,
        crate::routes::leadership::reference,
        crate::routes::leadership::profile,
        crate::routes::leadership::declare_redaction,
        crate::routes::leadership::confirm_redaction,
        crate::routes::leadership::record_adoption,
        crate::routes::leadership::link_project,
        crate::routes::leadership::links,
        crate::routes::leadership::acknowledge_link,
        crate::routes::leadership::record_retrospective,
        crate::routes::leadership::my_retrospectives,
        crate::routes::leadership::add_action,
        crate::routes::leadership::actions,
        crate::routes::leadership::resolve_action,
        crate::routes::leadership::lead_cohort,
        crate::routes::leadership::graduate_member,
        crate::routes::leadership::record_departure,
        crate::routes::leadership::conclude_cohort,
        crate::routes::leadership::cohort_outcomes,
        // The same debt on the write side: routes that change state and that
        ...
        crate::routes::cohorts::post_message,
        crate::routes::cohorts::remove_member,
        crate::routes::external_signals::create,
        crate::routes::external_signals::moderator_verify,
        crate::routes::goals::create,
        crate::routes::linear_webhook::receive,
        crate::routes::maintainer_digest::subscribe,
        crate::routes::peer_matching::enroll,
        crate::routes::peer_matching::schedule_session,
        crate::routes::slice_diary::create,
        crate::routes::slice_validation::pickup,
        crate::routes::talent_offers::create,
        crate::routes::user_notes::remove,
        crate::routes::user_notes::upsert,
        crate::routes::validator_applications::admin_reject,
        crate::routes::validator_applications::apply,
        crate::routes::validator_applications::withdraw,
        crate::routes::vouchings::break_vouching,
        crate::routes::vouchings::create,
        // Documented late: these handlers had no `#[utoipa::path]` at all, so
        // they were invisible to every reader of the document and to the
        // 5xx sweep. Held in `UNDOCUMENTED_YET` until each one was written.
        crate::routes::ai_companion::list_interactions,
        crate::routes::ai_companion::quota,
        crate::routes::apprentice_verifications::mine,
        crate::routes::apprentice_verifications::queue,
        crate::routes::attestations_public::verify,
        crate::routes::attestations_public::verify_pdf,
        crate::routes::bookmarks::list_folders,
        crate::routes::bookmarks::list_mine,
        crate::routes::cohorts::fetch,
        crate::routes::cohorts::list,
        crate::routes::cohorts::list_members,
        crate::routes::cohorts::list_mine,
        crate::routes::enterprise_credits::get_invoice_pdf,
        crate::routes::external_signals::list_mine,
        crate::routes::external_signals::list_pending,
        crate::routes::external_signals::list_public,
        crate::routes::goals::list_mine,
        crate::routes::maintainer_digest::confirm,
        crate::routes::maintainer_digest::unsubscribe,
        crate::routes::peer_matching::list_enrollments,
        crate::routes::peer_matching::list_matches,
        crate::routes::peer_matching::proposals,
        crate::routes::projects::active_skilluvers,
        crate::routes::slice_validation::my_queue,
        crate::routes::talent_offers::browse,
        crate::routes::talent_offers::list_mine,
        crate::routes::user_notes::list_mine,
        crate::routes::validator_applications::my_applications,
        ...
        crate::routes::badge_svg::repo_validated_svg,
        crate::routes::badge_svg::user_validated_svg,
        crate::routes::bookmarks::remove,
        crate::routes::challenge_feed::feed,
        crate::routes::cohorts::add_member,
        crate::routes::cohorts::create_milestone,
        crate::routes::cohorts::delete_milestone,
        crate::routes::cohorts::join,
        crate::routes::cohorts::leave,
        crate::routes::cohorts::list_messages,
        crate::routes::cohorts::list_milestones,
        crate::routes::cohorts::update,
        crate::routes::external_signals::moderator_delete,
        crate::routes::external_signals::remove,
        crate::routes::goals::fetch,
        crate::routes::goals::remove,
        crate::routes::goals::update,
        crate::routes::peer_matching::cancel_session,
        crate::routes::peer_matching::check_in,
        crate::routes::peer_matching::create_match,
        crate::routes::peer_matching::end_match,
        crate::routes::peer_matching::list_sessions,
        crate::routes::peer_matching::unenroll,
        crate::routes::skill_tree::set_prerequisites,
        crate::routes::skill_tree::user_skill_tree,
        crate::routes::slice_diary::list,
        crate::routes::slice_validation::approve,
        crate::routes::slice_validation::reject,
        crate::routes::talent_offers::remove,
        crate::routes::talent_offers::update,
        crate::routes::timeline::admin_backfill_timeline,
        crate::routes::timeline::get_timeline,
        crate::routes::user_notes::fetch,
        crate::routes::validator_applications::accept_invitation,
        crate::routes::validator_applications::admin_approve,
        crate::routes::validator_applications::admin_invite,
        crate::routes::validator_applications::list_applications_admin,
        crate::routes::vouchings::withdraw,
        // The same again, found once the scanner stopped reading routers a
        // line at a time: a `.route(` whose literal sits on the next line was
        // invisible to it, and so was every route in the modules that write
        // them that way.
        crate::routes::admin_domains::featured_queue,
        crate::routes::admin_feature_flags::remove,
        crate::routes::admin_feature_flags::upsert,
        crate::routes::admin_projects::trigger_ingest,
        crate::routes::admin_slices::patch_slice_config,
        crate::routes::attestations::verify_certificate,
        crate::routes::design::iteration_stories,
        crate::routes::design_briefs::propose,
        crate::routes::design_briefs::publish,
        crate::routes::design_briefs::reject,
        crate::routes::design_briefs::withdraw,
        crate::routes::design_cloud::disconnect,
        crate::routes::design_uploads::complete,
        crate::routes::design_uploads::init,
        crate::routes::design_uploads::preview_url,
        crate::routes::featured::feature,
        crate::routes::mentorship::confirm_session,
        crate::routes::missions::accept_round,
        crate::routes::missions::deliver_round,
        crate::routes::missions::list_rounds,
        crate::routes::missions::rate,
        crate::routes::missions::request_changes,
        crate::routes::plagiarism::decide,
        crate::routes::plagiarism::flag,
        crate::routes::plagiarism::respond,
        crate::routes::series::attach,
        crate::routes::series::create,
        crate::routes::slices::submit_pr,
        crate::routes::tournament::admin_fund_prize,
        crate::routes::tournament::admin_outstanding_prizes,
        crate::routes::tournament::admin_refund_prize,
        // Registered late: these handlers carried a `#[utoipa::path]` and
        // were never added here, so they were absent from the published
        // document and from the sweep that reads it. Found by
        // `an_undocumented_route_is_not_a_hidden_one`.
        crate::routes::admin_domains::overview,
        crate::routes::admin_domains::reviewers,
        crate::routes::admin_feature_flags::list,
        crate::routes::admin_slices::list_slices,
        crate::routes::admin_validators::collusion_matrix,
        crate::routes::admin_validators::validator_stats,
        crate::routes::attestations::verify_card,
        crate::routes::code_stats::top_languages,
        crate::routes::code_stats::user_languages,
        crate::routes::design::auto_checks,
        crate::routes::design::compare,
        crate::routes::design::next_challenges,
        crate::routes::design::version_at,
        crate::routes::design_briefs::mine,
        crate::routes::design_briefs::queue,
        crate::routes::design_cloud::inspect,
        crate::routes::design_cloud::list_connections,
        crate::routes::design_cloud::start,
        crate::routes::design_uploads::download_url,
        crate::routes::design_uploads::parts,
        crate::routes::enterprise_credits::get_invoice_html,
        crate::routes::featured::card,
        crate::routes::featured::recent,
        crate::routes::featured::this_week,
        crate::routes::missions::list_ratings,
        crate::routes::missions::standing,
        crate::routes::plagiarism::queue,
        crate::routes::plagiarism::read,
        crate::routes::series::list,
        crate::routes::series::one,
        crate::routes::series::standings,
        ...
        crate::routes::practice::adopt,
        crate::routes::practice::decline,
        crate::routes::practice::terrains,
        crate::routes::practice::toolkit,
        crate::routes::domain_profile::mentor_matches,
        crate::routes::domain_profile::get_profile,
        crate::routes::domain_profile::put_profile,
        crate::routes::domain_profile::skip_profile,
        crate::routes::admin_missions::list,
        crate::routes::admin_missions::detail,
        crate::routes::admin_missions::arbitrate,
        crate::routes::admin_missions::take_down,
        ...
        crate::routes::slice_revisions::list_revisions,
        crate::routes::slice_revisions::request_revision,
        crate::routes::slice_revisions::resolve_revision,
        ...
        crate::routes::portfolios::list_platforms,
        crate::routes::portfolios::my_portfolios,
        crate::routes::portfolios::declare_portfolio,
        crate::routes::portfolios::drop_portfolio,
        crate::routes::communication::user_communication_profile,
        crate::routes::communication::my_review_languages,
        crate::routes::communication::declare_review_language,
        crate::routes::communication::drop_review_language,
        crate::routes::communication::list_translation_reviews,
        crate::routes::communication::review_translation,
        crate::routes::communication::list_publications,
        crate::routes::education::user_education_profile,
        crate::routes::education::list_outcomes,
        crate::routes::education::record_outcome,
        crate::routes::education::conclude_cohort,
        crate::routes::education::declare_learner_data_cleared,
        crate::routes::education::list_adoptions,
        crate::routes::education::adopt_curriculum,
        ...
        crate::routes::enterprise_credits::get_invoice_preview,
        ...
        // The game domain.
        crate::routes::game::jam_detail,
        crate::routes::game::jam_submit,
        crate::routes::game::jam_vote,
        crate::routes::game::playtests_list,
        crate::routes::game::playtest_submit,
        crate::routes::game::gate_status,
        crate::routes::game::recruit_open,
        crate::routes::game::recruit_close,
        crate::routes::game::mod_register,
        crate::routes::game::mods_mine,
        crate::routes::game::mod_get,
        crate::routes::game::composition,
        crate::routes::game::featured_recent,
        crate::routes::game::featured_of_week,
        crate::routes::game::featured_of_user,
        crate::routes::game::profile_get,
        crate::routes::game::profile_recompute,
        crate::routes::admin_game::validate_slice,
        crate::routes::admin_game::mods_pending,
        crate::routes::admin_game::mod_confirm,
        crate::routes::admin_game::mod_refuse,
        crate::routes::admin_game::mod_downloads,
        crate::routes::admin_game::jam_create,
        crate::routes::admin_game::jam_finalize,
        crate::routes::admin_game::issue_shipped_title,
        crate::routes::admin_game::issue_open_source,
        crate::routes::admin_game::feature_creator,
        // Front-end feedback batch additions.
        crate::routes::design_profile::set_availability,
        crate::routes::ecosystem::request_upload,
        crate::routes::additional_products::my_placements_as_junior,
    ),
    components(
        schemas(
            ...
            crate::routes::practice::ToolkitRow,
            ...
            crate::routes::maintainer_digest::SubscribeBody,
            crate::routes::peer_matching::EnrollBody,
            crate::routes::peer_matching::ScheduleSessionBody,
            crate::routes::slice_diary::CreateEntryBody,
            crate::routes::talent_offers::CreateOfferBody,
            crate::routes::user_notes::UpsertNoteBody,
            crate::routes::validator_applications::RejectBody,
            crate::routes::vouchings::BreakBody,
            crate::routes::vouchings::CreateVouchingBody,
            crate::services::apprentice_verification::VerdictPayload,
            crate::services::validator_applications::ApplyInput,
            crate::routes::cohorts::AddMemberBody,
            crate::routes::cohorts::CreateMilestoneBody,
            crate::routes::cohorts::UpdateCohortBody,
            crate::routes::goals::UpdateGoalBody,
            crate::routes::peer_matching::CheckInBody,
            crate::routes::peer_matching::CreateMatchBody,
            crate::routes::skill_tree::SetPrerequisitesBody,
            crate::routes::slice_validation::RejectBody,
            crate::routes::talent_offers::UpdateOfferBody,
            crate::services::apprentice_verification::SubmitPayload,
            crate::services::validator_applications::InviteInput,
            ErrorResponse,
            ErrorObject,
            MetaInfo,
            SimpleMessage,
            ...
            crate::routes::admin_missions::AdminMissionRow,
            crate::routes::admin_missions::AdminMissionDetail,
            crate::routes::admin_missions::ArbitrateBody,
            crate::routes::admin_missions::TakeDownBody,
            crate::routes::admin_missions::AdminMissionListResponse,
            crate::routes::admin_security::CommentBody,
            ...
            crate::routes::slice_revisions::RevisionRow,
            crate::routes::slice_revisions::RequestRevisionBody,
            crate::routes::slice_revisions::ResolveRevisionBody,
            crate::routes::portfolios::PlatformRow,
            crate::routes::portfolios::PortfolioRow,
            crate::routes::portfolios::DeclarePortfolioBody,
            crate::services::communication_profile::CommunicationProfile,
            crate::services::communication_profile::CommunicationHighlight,
            crate::services::communication_profile::LanguageRow,
            crate::routes::communication::ReviewLanguageRow,
            crate::routes::communication::DeclareLanguageBody,
            crate::routes::communication::TranslationReviewRow,
            crate::routes::communication::ReviewTranslationBody,
            crate::routes::communication::PublicationRow,
            crate::services::education_profile::EducationProfile,
            crate::services::education_profile::EducationHighlight,
            crate::services::education_profile::CohortSummary,
            crate::routes::education::OutcomeRow,
            crate::routes::education::RecordOutcomeBody,
            crate::routes::education::AdoptionRow,
            crate::routes::education::AdoptBody,
            crate::routes::opportunities::OpportunityRow,
            crate::routes::opportunities::CreateOpportunityBody,
            crate::routes::opportunities::WithdrawBody,
