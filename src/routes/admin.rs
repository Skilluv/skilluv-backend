...
async fn create_challenge(
    ...
    let challenge: Challenge = sqlx::query_as(
        ...
        INSERT INTO challenges (
            ...
            mode, duration_minutes, ai_allowed, tone, language,
            prerequisite_fragments, reward_fragments, is_onboarding,
            expected_output, test_cases, created_by, status
    ...
    .bind(body.ai_allowed.unwrap_or(false))
    ...
    .bind(body.is_onboarding.unwrap_or(false))
...
async fn update_challenge(
    ...
    let challenge: Challenge = sqlx::query_as(
        ...
        UPDATE challenges SET
            ...
            tone = $9, language = $10, prerequisite_fragments = $11,
            reward_fragments = $12, expected_output = $13, test_cases = $14,
            updated_at = NOW()
        WHERE id = $15
        RETURNING *
        "#,
    ...
    .bind(body.ai_allowed.unwrap_or(existing.ai_allowed))
