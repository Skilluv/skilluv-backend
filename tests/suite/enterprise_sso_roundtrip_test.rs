...
use crate::common::mock_oidc::MockIdp;
use reqwest::redirect::Policy;
use reqwest::{Client, StatusCode};
use serde_json::json;

fn manual_client(app: &crate::common::TestApp) -> Client {
...
async fn setup_sso(app: &crate::common::TestApp, slug: &str, idp: &MockIdp, enforce: bool) {
