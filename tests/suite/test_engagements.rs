...
async fn a_studio_carries_its_shares_onto_the_work() {
    ...
    crate::common::assert_decimal(&shares[0].1, "60.00");
}
...
async fn an_accepted_milestone_pays_the_team_by_their_shares() {
    ...
    crate::common::assert_amount(amount_for(a), "15300.00");
    crate::common::assert_amount(amount_for(b), "10200.00");
    ...
    .await
    .unwrap();
    crate::common::assert_decimal(&revenue.0, "4500.00");
...
async fn the_quote_is_the_maximum_the_client_can_be_billed() {
    ...
    crate::common::assert_amount(&body["data"]["quoted_maximum"], "625.00");
}
...
async fn the_program_fee_is_booked_at_closing_not_at_opening() {
    ...
    .await
    .unwrap();
    crate::common::assert_decimal(&booked, "500.00");
}
