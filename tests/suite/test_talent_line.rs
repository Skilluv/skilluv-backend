...
async fn the_maximum_cost_is_shown_before_anybody_starts() {
    ...
    // first invoice.
    crate::common::assert_amount(&body["data"]["maximum_cost"], "11200.00");
}
...
async fn only_approved_hours_are_settled() {
    ...
    crate::common::assert_amount(&body["data"]["talent_owed"], "544.00");
    crate::common::assert_amount(&body["data"]["platform_share"], "96.00");
}
